...
def visualization_directory():
    ...
    try:
        ...
        if os.path.exists(output_dir):
            ...
            print(
                f"\033[91m{'WARNING: Directory creation appeared to succeed but directory doesn\'t exist.':^180}\033[0m")
            print("\033[91m-\033[0m" * 180 + "\n")
...
def save_visualization(fig, filename, output_dir, close_after=True):
    ...
    try:
        ...
        print("-" * 180)
        print(f"Error saving {filename}: {str(e)}".center(180))
        print("-" * 180 + "\n")
        traceback.print_exc()
        return False
...
def load_and_process_data(output_dir):
    ...
    """ TODO: This could possibly be moved to another method. """
